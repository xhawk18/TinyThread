...
#define LED_GPIO_ICE_GRP	GPB
#define LED_GPIO_ICE_BIT	4
#define LED_GPIO_ISP_GRP	GPB
#define LED_GPIO_ISP_BIT	5
#define LED_GPIO_RED_GRP	GPB
#define LED_GPIO_RED_BIT	6
#define LED_GPIO_GREEN_GRP	GPB
...
static unsigned int	stack[THREAD_NUM][TT_THREAD_BUFFER_SIZE(32)];
...
int main()
{
	...
	DrvGPIO_Open(LED_GPIO_GREEN_GRP, LED_GPIO_GREEN_BIT, IO_OUTPUT);
	DrvGPIO_Open(LED_GPIO_RED_GRP, LED_GPIO_RED_BIT, IO_OUTPUT);
	DrvGPIO_Open(LED_GPIO_ISP_GRP, LED_GPIO_ISP_BIT, IO_OUTPUT);
	DrvGPIO_Open(LED_GPIO_ICE_GRP, LED_GPIO_ICE_BIT, IO_OUTPUT);
