/******************************************************************************
 * @file     Ccid_if.c
 * @brief    This file provides all the CCID interface functions.
 * @version  V1.0.1
...
uint8_t PC_to_RDR_IccPowerOff(void)
{
	...
	SMARTCARD_DeactivationCmd((S_SC_DEV_T *)&sc_device[UsbMessageBuffer[OFFSET_BSLOT]]);
...
void RDR_to_PC_NotifySlotChange(void)
{
	...
	if( SMARTCARD_CheckCardPresent( SC0 ) == SCARD_PRESENT )
	{
