...
static void WAU8822_Setup(void)
{
	...
	I2C_WriteWAU8822(52,  0x010);        
	I2C_WriteWAU8822(53,  0x010);   /* Enable L/R Headphone, ADC Mix/Boost, ADC */
}
...
int32_t UAC_MainProcess(void)
{
	...
	GPIO_Open(GPIOD, GPIO_PMD_PMD2_OPEN_DRAIN, GPIO_PMD_PMD2_MASK);
	GPIO_Open(GPIOD, GPIO_PMD_PMD3_OPEN_DRAIN, GPIO_PMD_PMD3_MASK);
	GPIO_SetBit(GPIOD, 2);
	GPIO_SetBit(GPIOD, 3);
