/******************************************************************************
 * @file     Smpl_Main.c
 * @brief    Nano1xx NUTINY-EVB_NANO130 PDRDWN_RTC_DEMO Demo code
 *           System enters power down mode and turn off LCD display. Besdies,
 *           system will wake up for every one minute due to RTC alarm interrupt
 * @version  1.0.1
