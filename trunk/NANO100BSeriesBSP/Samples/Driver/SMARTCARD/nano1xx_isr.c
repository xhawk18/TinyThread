...
extern /*volatile*/ uint32_t atr_len0, atr_remain0;
extern /*volatile*/ uint32_t atr_len1, atr_remain1;
extern /*volatile*/ uint32_t atr_len2, atr_remain2;
extern /*volatile*/ int32_t atr_check_time0,atr_check_time1,atr_check_time2;
extern /*volatile*/ int32_t atr_final_chk0, atr_final_chk1, atr_final_chk2;
extern /*volatile*/ int32_t atr_time0, atr_time1, atr_time2;
extern /*volatile*/ int32_t atr_total_time_start_flag0;
extern /*volatile*/ int32_t atr_total_time_start_flag1;
extern /*volatile*/ int32_t atr_total_time_start_flag2;
extern /*volatile*/ int32_t ifbyte_flag0, tck0, ifcount0;
extern /*volatile*/ int32_t ifbyte_flag1, tck1, ifcount1;
extern /*volatile*/ int32_t ifbyte_flag2, tck2, ifcount2;
extern /*volatile*/ uint8_t g_SC0UnexpectedInBuf[MIN_BUFFER_SIZE], g_SC1UnexpectedInBuf[MIN_BUFFER_SIZE], g_SC2UnexpectedInBuf[MIN_BUFFER_SIZE];
extern /*volatile*/ uint8_t g_SC0UnexpectedBufLen, g_SC1UnexpectedBufLen, g_SC2UnexpectedBufLen;
        ...
        if(SC->ISR & (SC_ISR_RDA_IS | SC_ISR_RTMR_IS)) {
                if(dev->op_state == SC_OP_READ) {
                        ...
                        if( SC->ISR & SC_ISR_RDA_IS ) {
                                dev->rcv_buf[dev->rcv_pos + dev->rcv_cnt++] = SC_GET_ONE_BYTE();
