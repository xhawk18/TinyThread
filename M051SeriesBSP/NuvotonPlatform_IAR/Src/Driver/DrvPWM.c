...
uint32_t DrvPWM_SetTimerClk(uint8_t u8Timer, S_DRVPWM_TIME_DATA_T *sPt)
{
	...
	switch (u8Timer)
	{
		...
		case DRVPWM_CAP3:
			...
			break;
		case DRVPWM_CAP4:
			outp32(&PWMB->CCR0, (inp32(&PWMB->CCR0) & CCR_MASK) | BIT0);
			break;
		case DRVPWM_CAP5:
			outp32(&PWMB->CCR0, (inp32(&PWMB->CCR0) & CCR_MASK) | BIT16);
			break;
		case DRVPWM_CAP6:
			outp32(&PWMB->CCR2, (inp32(&PWMB->CCR2) & CCR_MASK) | BIT0);
			break;
		case DRVPWM_CAP7:
			outp32(&PWMB->CCR2, (inp32(&PWMB->CCR2) & CCR_MASK) | BIT16);
			break;
	} 
